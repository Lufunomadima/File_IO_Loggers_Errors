...
import java.time.LocalTime;
    ...
    public class Visitor {
        ...
        public Visitor(String fullName, String assistant_Name, String comments, LocalDate dateOfVisit, LocalTime timeOfVisits, int age) {
        ...
        void save() throws IOException {
            ...
            try (FileWriter fileWriter = new FileWriter(fileName)) {
                ...
                throw new IOException("The was a problem in writing to the file");
            }
        }
